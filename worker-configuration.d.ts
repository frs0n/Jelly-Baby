/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4000c9ffe158c8a4114d79e50a7836e9)
// Runtime types generated with workerd@1.20260903.1 2026-09-06 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	ROOMS: DurableObjectNamespace<import("./server/index").JellyRoom>;
	MATCHMAKER: DurableObjectNamespace<import("./server/index").Matchmaker>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server/index");
		durableNamespaces: "JellyRoom" | "Matchmaker";
	}
